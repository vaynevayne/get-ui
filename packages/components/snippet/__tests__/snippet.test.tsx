...
describe("Snippet", () => {
  ...
  it("should include the code", () => {
    const wrapper = render(
      <Snippet data-testid="code-test">npm install @get-ui/react</Snippet>,
    );

    expect(wrapper.getByTestId("code-test")).toHaveTextContent("npm install @get-ui/react");
  });

  it("should render multiple <pre> tags when children is an array of string", () => {
    const wrapper = render(
      <Snippet data-testid="code-test">
        {["npm install @get-ui/react", "npm install @get-ui/react"]}
      </Snippet>,
    );
...
describe("Snippet - Clipboard", () => {
  ...
  it('should copy text to clipboard when "copy" button is clicked', async () => {
    ...
    let code = "npm install @get-ui/react";
