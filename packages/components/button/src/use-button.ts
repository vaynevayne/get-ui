import type {ButtonVariantProps} from "@get-ui/theme";
import type {AriaButtonProps} from "@get-ui/use-aria-button";
import type {HTMLNextUIProps, PropGetter} from "@get-ui/system";
import type {ReactNode} from "react";

import {dataAttr} from "@get-ui/shared-utils";
import {ReactRef} from "@get-ui/react-utils";
import {MouseEventHandler, useCallback} from "react";
import {useFocusRing} from "@react-aria/focus";
import {chain, mergeProps} from "@react-aria/utils";
import {useDOMRef, filterDOMProps} from "@get-ui/react-utils";
import {button} from "@get-ui/theme";
import {isValidElement, cloneElement, useMemo} from "react";
import {useAriaButton} from "@get-ui/use-aria-button";
import {useHover} from "@react-aria/interactions";
import {SpinnerProps} from "@get-ui/spinner";
import {useRipple} from "@get-ui/ripple";
